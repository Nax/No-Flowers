...
void Shader::uniform(ShaderUniform uniform, Matrix4f mat) const
{
    glUniformMatrix4fv(_locations[int(uniform)], 1, GL_FALSE, mat.data());
}

void Shader::uniform(ShaderUniform uniform, unsigned value) const
{
    glUniform1ui(_locations[int(uniform)], value);
}
